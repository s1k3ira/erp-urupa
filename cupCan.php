...
<script>
	function listarDias(){
		...
		location.href='cupCan.php?dati='+diai+'&datf='+diaf+'&sit=3';
	}
</script>
...
?>
  <tr bgcolor="<?= $cor?>">
        ...
        <td align="center"><a href="cupChe.php?cid=<?= $cli["CID"]?>&dati=<?= $_GET[dati]?>&datf=<?= $_GET[datf]?>&sit=3"><img src="pictures/b_search.png" border="0" /></a></td>
  </tr>
<?
}
?>
