...
<script>
	function deletaCli(id, nome){		
		if(confirm('Deletar o cliente '+nome+' ?')){
			location.href='gereJur.php?action=deletaCli&id='+id+'';
		}
	}
</script>
...
<body>
<div><span class="titulo"><strong>Pessoa Jurídica</strong></span></div>
<hr />
<form action="<?= $PHP_SELF?>" name="listaCli" method="post">
<input type="hidden" name="action" value="buscar" /> 
<table width="100%" cellspacing="0">
	<tr>
   	  <td width="5%" height="25" class="tabsis">&nbsp;<a href="#" onclick="location.href='cadaJur.php';" /><img src="pictures/Knob Add.png" width="20" border="0" /></a></td>
        <td width="9%" class="tabsis">
     <div align="left">&nbsp;CNPJ:</div>
...
<table width="100%" cellpadding="0" cellspacing="0">
  <tr class="tabescu"> 
    	<td width="12%"><strong>CNPJ</strong></td>
...
?>
  <tr bgcolor="<?= $cor?>">
        ...
        <td><?= $ust["CLI_SITU"]?></td>
        <td><a href="cadaJur.php?id=<?= $ust["ID"]?>"> <img src="pictures/b_edit.png" alt="Editar" border="0" /></a> <a href="#" onClick="deletaCli('<?= $ust["ID"]?>', '<?= $ust["CLI_NOME"]?>');"><img src="pictures/b_drop.png" alt="Apagar" border="0" /></a></td>
  </tr>
<?
}
?>
