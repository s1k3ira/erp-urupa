...
<script>
	$(document).ready(function() {
		$("a").click(function () {
			$("a").css({"font-weight":"normal"}); // un-bold all the model links
...
| <a href="cupAbe.php?sit=1&tip=v" target="gereCup">Vencidos(<?= $totalv?>)</a> 
| <a href="cupAbe.php?sit=1" target="gereCup">Abertos(<?= $totala?>)</a>
| <a href="cupAbe.php?sit=4" target="gereCup">Baixados(<?= $totalb?>)</a>
| <a href="cupAbe.php?sit=2" target="gereCup">Fechados(<?= $totalf?>)</a>
| <a href="cupAbe.php?sit=3" target="gereCup">Cancelados(<?= $totalc?>)</a>
</div>
<hr />
