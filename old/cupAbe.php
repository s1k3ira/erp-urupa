...
<script>
	function listarDias(){
		...
		location.href='cupAbe.php?dati='+diai+'&datf='+diaf+'&sit=1';
	}
</script>
...
?>
  <tr bgcolor="<?= $cor?>">
        ...
        <td align="center"><a href="cupChe.php?cid=<?= $cli["CID"]?>&dati=<?= $_GET[dati]?>&datf=<?= $_GET[datf]?>&sit=1"><img src="pictures/b_search.png" border="0" /></a></td>
  </tr>
<?
}
?>
