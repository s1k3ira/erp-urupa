...
<script>
	function listarDias(){
		...
		location.href='cupFec.php?dati='+diai+'&datf='+diaf+'&sit=2';
	}
</script>
...
?>
  <tr bgcolor="<?= $cor?>">
        ...
        <td align="center"><a href="cupChe.php?cid=<?= $cli["CID"]?>&dati=<?= $_GET[dati]?>&datf=<?= $_GET[datf]?>&sit=2"><img src="pictures/b_search.png" border="0" /></a></td>
  </tr>
<?
}
?>
