...
if($_POST[action] == "cadaCli"){
	...
	$cliente->setCnpj($_POST[juriCnpj]);
	$cliente->setInsc($_POST[cliInsc]);
	...
	$cliente->setTipo("1");
	$last = $cliente->cadaJur();
	?>
    <script>
		location.href='cadaJur.php?id=<?= $last?>';
    </script>
	<?	
...
if($_POST[action] == "updaCli"){
	...
	?>
    <script>
		alert('CLIENTE JURÍDICO CADASTRADO COM SUCESSO !!!');
...
<div id="jurMenu"><strong>&nbsp;Dados da Empresa</strong></div>
<div id="jurDados">
	...
	<tr>
    	<td width="380">
            <table width="100%">
                ...
                <tr>
                    <td>CNPJ</td>
                    <td><input name="juriCnpj" type="text" class="input" lang="1" onFocus="mudarCorCampo(this,'white')" onKeyPress="formatar_mascara(this, '##.###.###/####-##')" value="<?= $cli["CLI_CNPJ"]?>" size="29"  maxlength="18" xml:lang="1" /></td>
                </tr>
                <tr>
                    <td>Inscrição Estadual</td>
                    <td><input class="input"  type="text" size="29"  id="cliInsc" name="cliInsc" value="<?= $cli["CLI_INSC"]?>" /></td>
                </tr>
                 <tr>
                    <td>Responsável</td>
